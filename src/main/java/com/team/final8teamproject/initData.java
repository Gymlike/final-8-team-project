...
//            .parkingLot(true).wifi(true).towel(true)
//            .locker(true).showerRoom(true)
//            .build();
...
//            .build();
//
//    Amenities amenities2 = Amenities.builder()
//            .parkingLot(true).wifi(true).towel(true)
//            .build();
...
//            .build();
//
//    Amenities amenities3 = Amenities.builder()
//            .parkingLot(true).wifi(true).towel(true)
//            .locker(true).showerRoom(true)
//            .build();
...
//            .build();
//
//    Amenities amenities4 = Amenities.builder()
//            .wifi(true).towel(true)
//            .locker(true).showerRoom(true)
//            .build();
...
//            .build();
//
//    Amenities amenities5 = Amenities.builder()
//            .parkingLot(true).wifi(true).towel(true)
//            .locker(true).showerRoom(true)
//            .build();
//
...
//            .build();
//
//    Amenities amenities6 = Amenities.builder()
//            .parkingLot(true).wifi(true).towel(true)
//            .locker(true).showerRoom(true)
//            .build();
...
//            .build();
//
//    Amenities amenities7 = Amenities.builder()
//            .parkingLot(true).wifi(true).towel(true)
//            .locker(true).showerRoom(true)
//            .build();
...
//    gymAmenitiesRepository.save(amenities2);
//    gymAmenitiesRepository.save(amenities3);
//    gymAmenitiesRepository.save(amenities4);
//    gymAmenitiesRepository.save(amenities5);
//    gymAmenitiesRepository.save(amenities6);
//    gymAmenitiesRepository.save(amenities7);
